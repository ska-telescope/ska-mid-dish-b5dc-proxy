...
class B5dcManager(SKABaseDevice):
    """Implementation of the B5dcManager Tango device."""
    ...
    def create_component_manager(self: "B5dcManager") -> B5dcDeviceComponentManager:
        """
    ...
    def rfcmFrequency(self: "B5dcManager") -> float:
    ...
    def rfcmPllLock(self: "B5dcManager") -> B5dcPllState:
    ...
    def rfcmHAttenuation(self: "B5dcManager") -> float:
    ...
    def rfcmVAttenuation(self: "B5dcManager") -> float:
    ...
    def clkPhotodiodeCurrent(self: "B5dcManager") -> float:
    ...
    def hPolRfPowerIn(self: "B5dcManager") -> float:
    ...
    def vPolRfPowerIn(self: "B5dcManager") -> float:
    ...
    def hPolRfPowerOut(self: "B5dcManager") -> float:
    ...
    def vPolRfPowerOut(self: "B5dcManager") -> float:
    ...
    def rfTemperature(self: "B5dcManager") -> float:
    ...
    def rfcmPsuPcbTemperature(self: "B5dcManager") -> float:
    ...
    def SetHPolAttenuation(self: "B5dcManager", attenuation_db: int) -> DevVarLongStringArrayType:
    ...
    def SetVPolAttenuation(self: "B5dcManager", attenuation_db: int) -> DevVarLongStringArrayType:
    ...
    def SetFrequency(self: "B5dcManager", frequency: B5dcFrequency) -> DevVarLongStringArrayType:
...
def main(args: Any = None, **kwargs: Any) -> None:
    """Launch an instance of the B5dcManager Tango device."""
    return run((B5dcManager,), args=args, **kwargs)
